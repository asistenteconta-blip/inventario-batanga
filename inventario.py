...
st.warning(
    ...
    "⚠ El valor final de inventario lo calcula Google Sheets, pero puedes verlo en la vista previa."
)
...
st.subheader("Ingresar inventario (debes de ingresar los datos dos veces)")
